        ...
        try {
            if (ctx.scene.state.btns) {
                if (ctx.scene.state.btns.thirdbtntext) {
                    await ctx.telegram.sendCopy(ctx.scene.state.audience[i].chat_id, ctx.scene.state.spam_msg, params.Extra.HTML().markup((m) =>
                        m.inlineKeyboard([
                ...
                await ctx.telegram.sendCopy(ctx.scene.state.audience[i].chat_id, ctx.scene.state.spam_msg, params.Extra.HTML())
            }
