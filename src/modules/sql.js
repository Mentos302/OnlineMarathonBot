module.exports = {
    ...
    newUser(ctx, date) { return `INSERT INTO users (chat_id, first_name, reg_date, phone_number) VALUES ('${ctx.from.id}','${ctx.scene.state.cliname}','${date}','${ctx.scene.state.cliphone}')` },
